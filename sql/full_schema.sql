...
-- =====================================================
-- 7. 钢材材质字典表 (旧: DS.T_BASIC_STEEL_QUALITY)
--   新增 getQuality 接口所需
-- =====================================================
...
-- =====================================================
-- 9. 附件数据表 T_COMPONENTS_ATT_DATA (旧: MA.T_COMPONENTS_ATT_DATA)
-- =====================================================
...
-- =====================================================
-- 10. 引用/报价表 T_COMPONENTS_QUOTE (旧: MA.T_COMPONENTS_QUOTE)
-- =====================================================
...
-- =====================================================
-- 15. 工装台账主表 T_COMPONENTS_LEDGER (旧: MA.T_COMPONENTS_LEDGER)
--     工装借出/归还管理
-- =====================================================
...
-- =====================================================
-- 16. 台账明细表 T_COMPONENTS_LEDGER_LIST (旧: MA.T_COMPONENTS_LEDGER_LIST)
-- =====================================================
...
-- =====================================================
-- 17. 台账汇总表 T_COMPONENTS_LEDGER_GATHER (旧: MA.T_COMPONENTS_LEDGER_GATHER)
-- =====================================================
...
-- =====================================================
-- 18. 台账单据表 T_COMPONENTS_LEDGER_BILL (旧: MA.T_COMPONENTS_LEDGER_BILL)
-- =====================================================
...
-- =====================================================
-- 19. 台账类型表 T_COMPONENTS_LEDGER_TYPE (旧: MA.T_COMPONENTS_LEDGER_TYPE)
-- =====================================================
...
-- =====================================================
-- 20. 台账审批意见表 T_COMPONENTS_LEDGER_OPINION (旧)
-- =====================================================
...
-- =====================================================
-- 21. 台账附件表 T_COMPONENTS_LEDGER_ATT (旧)
-- =====================================================
